...
expert_model_id="google/gemma-3-27b-it"
amateur_model_id="google/gemma-3-27b-pt"

# Dataset
input_path=${3:-"../data/example.jsonl"}
output_path=${4:-"../outputs/example-gemma-3-27b-CoDIT.jsonl"}
output_path_baseline=${5:-"../outputs/example-gemma-3-27b.jsonl"}
