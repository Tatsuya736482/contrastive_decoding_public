...
# Model settings
tensor_parallel_size=${2:-2} # If you use Contrastive Decoding, need 2*tensor_parallel_size gpus.
expert_model_id="Qwen/Qwen3-30B-A3B"
amateur_model_id="Qwen/Qwen3-30B-A3B-Base"

# Dataset
input_path=${3:-"../data/example.jsonl"}
output_path=${4:-"../outputs/example-Qwen3-30B-A3B-CoDIT.jsonl"}
output_path_baseline=${5:-"../outputs/example-Qwen3-30B-A3B.jsonl"}
...
# GPU selection
CUDA_VISIBLE_DEVICES_AMA="0,1"
CUDA_VISIBLE_DEVICES_EXP="2,3"
