...
expert_model_id="meta-llama/Llama-3.2-3B-Instruct"
amateur_model_id="meta-llama/Llama-3.2-3B"

# Dataset
input_path=${3:-"../data/example.jsonl"}
output_path=${4:-"../outputs/example-Llama-3.2-3B-CoDIT.jsonl"}
output_path_baseline=${5:-"../outputs/example-Llama-3.2-3B.jsonl"}
