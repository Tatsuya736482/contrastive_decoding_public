...
expert_model_id="meta-llama/Llama-3.1-8B-Instruct"
amateur_model_id="meta-llama/Llama-3.1-8B"

# Dataset
input_path=${3:-"../data/example.jsonl"}
output_path=${4:-"../outputs/example-Llama-3.1-8B-CoDIT.jsonl"}
output_path_baseline=${5:-"../outputs/example-Llama-3.1-8B.jsonl"}
