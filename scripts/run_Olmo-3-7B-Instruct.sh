...
expert_model_id="allenai/Olmo-3-7B-Instruct"
amateur_model_id="allenai/Olmo-3-1025-7B"

# Dataset
input_path=${3:-"../data/Dolci-Instruct-SFT-100K.jsonl"}
output_path=${4:-"../outputs/Dolci-Instruct-SFT-100K-Olmo-3-7B-Instruct-CD.jsonl"}
output_path_baseline=${5:-"../outputs/Dolci-Instruct-SFT-100K-Olmo-3-7B-Instruct.jsonl"}
